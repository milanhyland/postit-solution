...
function closeNewDiv(){
 ...
 document.getElementById("player").style.width=640;
   document.getElementById("player").style.visibility='visible';
document.getElementById("showSomething").style.width=0;
document.getElementById("showSomething").style.visibility="hidden";
...
jwplayer().on('time', function(e){
 ...
 if( Math.floor(jwplayer().getPosition()) == 4 & check10 =="true"){
...
fullscreen=1;
  ...
  document.getElementById("showSomething").style.position= "absolute";
  document.getElementById("showSomething").style.width=640;
